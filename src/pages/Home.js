   ...
   <NavBar/>
      <div className="container-fluid slider-margin ">
        ...
        <div className="option carousel-caption">
          <h1 className='heading-text'>YOUR BLOOD <br /> THEIR HOPE</h1>
          ...
          <div class="item-button">
                      <button onclick="" id="myBtn"><h6><Link className="nav-link" to="/bloodinfo">Read More</Link>
</h6></button>
...
<div className="container-fluid mt-1 s1">
    ...
    <div className="row row1 g-2">
      <div className="col-md">
        <div className="form-floating ">
          <select className="form-select text-center" id="floatingSelectGrid" aria-label="Floating label select example">
  ...
  <div className="mt-5">
    <a href="#" className="b1 text-white text-decoration-none px-3 py-2 rounded-3">Search</a>
  </div> </div>
